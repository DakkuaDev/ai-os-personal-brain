...
- All fleet profiles exist (`ceo finanzas carrera salud research`).
...
## 3. Delegation test
1. Message CEO: "ask finanzas for the current portfolio snapshot".
2. CEO messages `finanzas` (Bot Chat), waits, relays the reply.
